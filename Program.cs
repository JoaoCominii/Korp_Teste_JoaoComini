...
Console.WriteLine("=== Sistema Korp Test - Com SQLite ===\n");
    ...
    switch (opcao)
    {
        ...
        case 6:
            ...
            else
            {
                ...
                {
                    Console.WriteLine((i + 1) + ". " + notas[i].Numero + ": Status=" + notas[i].Status + ", Produtos=" + notas[i].Produtos.Count);
                }
                ...
                if (int.TryParse(Console.ReadLine(), out int numSel) && numSel > 0 && numSel <= notas.Count)
                {
                    ...
                    Console.WriteLine("\nDetalhes da nota:");
                    Console.WriteLine("  Numero: " + nota.Numero);
...
if (estoque.ObterProduto(prodCod!).HasValue)
            ...
            {
                faturamento.CadastrarNotafiscal(listaProd);
                Console.WriteLine("\nNota fiscal criada!");
                Console.WriteLine("Produtos incluidos: " + listaProd.Count);
            }
            else
            {
