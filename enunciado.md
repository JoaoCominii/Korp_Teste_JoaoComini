...
(Envie para rh@korp.com.br).
3. O envio deve conter obrigatoriamente:
● Link público do repositório GitHub Korp_Teste_SeuNome
● Link para vídeo de apresentação das telas e funcionalidades implementadas (Google
Drive, One Drive ou alguma outra nuvem da sua preferência)
● Detalhamento técnico conforme itens descritos no documento de especificação deste
teste.